...
def load_character_genders(characters_path):
    ...
    with open(characters_path, encoding="latin1") as f:
        for line in f:
            ...
            # name = parts[1]  # si besoin
            # movie_id = parts[2]
            # movie_title = parts[3]
            gender = parts[4]  # ici 5e champ (index 4) est le genre
            # position = parts[5]  # si besoin
...
def analyze_romantic_conversations(convo_file, name_to_gender):
    ...
    with open(convo_file, 'r', encoding='utf-8') as f:
        for line in f:
            ...
            g1 = name_to_gender.get(character_ids[0], "?")
            g2 = name_to_gender.get(character_ids[1], "?")
            ...
            first_speaker_counts[name_to_gender.get(first, "?")] += 1
            last_speaker_counts[name_to_gender.get(last, "?")] += 1
